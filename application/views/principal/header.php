  ...
  <nav class="navbar navbar-default">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li><a href="<?=base_url()?>general/index.php/general/registro">Registro</a></li>
        <li><a href="<?=base_url()?>general/index.php/general/versiones">Descargas</a></li>
        <li><a href="<?=base_url()?>ayuda">Ayuda</a></li>

      </ul>
      
      <ul class="nav navbar-nav navbar-right">
        <li><a href="#">Contactanos: 022339487 / 0994725020</a></li>
