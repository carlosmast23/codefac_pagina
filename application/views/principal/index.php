...
<div class="container">
  ...
  <div class="col-md-6">
    ...
    <a class="btn btn-primary btn-block" href="<?=base_url()?>instalador/codefactlite1.2.5.exe"> <span class="glyphicon glyphicon-save"></span> Descargue CODEFAC-LITE!</a>
  ...
  <div class="col-md-6">
   ...
   <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      ...
      <div class="item">
        <img class="img-responsive" src="<?=base_url()?>img/banner3.png" />
        <div class="carousel-caption">
          <h3>LLeva el control de tus facturas online</h3>
          <p><a href="<?=base_url()?>general/registro" class="btn btn-default">Regístrate</a></p>
        </div>
...
<div class="col-md-12" id="caracteristicas">
  ...
  <div class="col-md-4 text-center">
    ...
    <p>Registra, consulta tus clientes.</p>
  </div>
  <div class="col-md-4 text-center">
    <h1 class="glyphicon glyphicon-briefcase"></h1>
    <h4>Administración de productos</h4>
    <p>Registra, consulta tus productos</p>
  </div>  
  <div class="col-md-4 text-center">
